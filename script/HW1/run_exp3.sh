...
PARAM_DIR="EXP_DIR/HW1_EXP3"
OUT_DIR="OUTPUT_DIR/HW1-EXP3"
...
# # Run all Experiment 3 query-set experiments
...
echo "=============================================="
echo "All Experiment 3 (Multifield BM25) experiments finished."


# # Generate CSV
python te2csv.py "$OUT_DIR/HW1-Exp"
mv te2csv.csv "$OUT_DIR/HW1_EXP3_Results.csv"

echo "CSV saved to $OUT_DIR/HW1_EXP3_Results.csv"
