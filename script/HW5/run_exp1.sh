...
PARAM_DIR="EXP_DIR/HW5_EXP1"
OUT_DIR="OUTPUT_DIR/HW5-EXP1"
...
BM25_INRANK="EXP_DIR/HW5_EXP1/HW5-Exp-BM25.inRank"
...
echo "=============================================="
echo "Starting HW5 Experiment 1"
echo "Params: $PARAM_DIR"
echo "Output: $OUT_DIR"
echo "=============================================="

for param in "$PARAM_DIR"/HW5-Exp-1.*.param
do
...
echo "=============================================="
echo "All HW5 Experiment 1 runs finished."

python3 script/HW5/exp1_to_csv.py

echo "----------------------------------------------"
echo "Metrics CSV: $OUT_DIR/HW5_Exp1_Metrics.csv"
